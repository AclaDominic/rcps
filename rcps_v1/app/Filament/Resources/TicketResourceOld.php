                    ...
                    ->schema([
                        Forms\Components\Grid::make()
                            ->schema([
                                ...
                                // ->label('Generate tasks with AI?') // Mas clear na label
                                // ->reactive()
                                // ->disabled(fn (callable $get) => blank($get('project_id')))
                                // ->helperText(function (callable $get) {
                                //     if (blank($get('project_id'))) {
                                //         return 'Please select a project first to enable AI task generation';
                                //     }
                                //     return 'Enable to generate main task and AI subtasks automatically';
                                // })
                                // ->afterStateUpdated(function ($state, $set, $get) {
                                //     if (!$state) {
                                //         $set('ai_subtask_count', 0);
                                //         $set('ai_description', '');
                                //         $set('relations', []);
                                //     }
                                // })->hidden(fn ($livewire) => $livewire instanceof \App\Filament\Resources\TicketResource\Pages\EditTicket),
                        ...
                        //             return false;
                        //         }else{
                        //             if(strval($get('dependency_mode')) === '2'){
                        //                 return true;
                        //             }else{
                        //                 return false;
                        //             }
                        ...
                        //                         $projectId = $livewire->data['project_id'];
                        //                         $query = Ticket::query();
