...
class User extends Authenticatable implements MustVerifyEmail, FilamentUser
{
    ...
    {
        return $this->getRoleNames()->first(); // returns string
    }

    public function hasRoleType(array $roleTypes)
    {
        return $this->roles()->whereIn('role_type', $roleTypes)->exists();
    }
